...
name: db_agent
description: >
  Inspects database schemas and authors/runs queries against a database
  exposed via MCP or CLI: explains data, drafts SQL, and reports results.
  Treats writes/DDL as high-impact.
model: high
tools:
  - Bash
  - Read
