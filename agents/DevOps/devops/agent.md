...
name: devops
description: >
  Operates infrastructure and triages incidents via CLIs and MCP servers
  (kubectl, docker, cloud tools): inspects cluster/service state, reads logs,
  and runs operational commands. Use when users need live infrastructure
  inspected, incidents diagnosed, or operational commands run carefully.
model: high
skills:
  - k8s-triage
